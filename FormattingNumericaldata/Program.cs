...
int[] sales = { 100000, 150000, 200000, 250000};
double[] intlMixPct = {.386, .413, .421, .457};
int val1 = 1234;
decimal val2 = 1234.567m;

// TODO: Specifying Numerical formatting
// General forat is {index[,alignment]:[format]}
// Common types are N (Number), G (General), F (Fixed-point),
// E (Exponential), D (Decimal), P (Percentage), X (Hexadecimal)
// C (Currency in local format), R (Currency in global format)
...
Console.WriteLine($"\n{val1:D6}, {val1:N2}, {val1:F1}, {val1:G3}\n");
